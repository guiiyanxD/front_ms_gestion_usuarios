...
export abstract class MaintenanceRequestRepository {
  ...
  abstract listByTechnician(tecnicoId: string, filters: ListRequestsFilters): Observable<PaginatedRequestsResult>;
  ...
  abstract updateDiagnostico(id: string, diagnostico: string): Observable<void>;
